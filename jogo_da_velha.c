...
int bloquearjogador(char tabuleiro[3][3]);
...
void boasvindas(void)
{
    ...
    printf("===================================\n");
    printf("Aviso: O jogador é o 'X' e o computador é o 'O'\n");
    printf("\n");
...
void partida(char tabuleiro[3][3])
{
    ...
    if (verificarvencedor(tabuleiro) == 0) 
    {
        ...
        if(espacos_vazios > 0)
        {
            if(bloquearjogador(tabuleiro)==0)
            {
...
int bloquearjogador(char tabuleiro[3][3])
{
    ...
    for(i=0;i<3;i++)
    {
        ...
        if(tabuleiro[i][0]=='X' && tabuleiro[i][1]==' ' && tabuleiro[i][2]=='X')
        {
            tabuleiro[i][1]='O';
            tabuleiroatualizado(tabuleiro);
            return 1;
        }
        if(tabuleiro[i][0]==' ' && tabuleiro[i][1]=='X' && tabuleiro[i][2]=='X')
        {
            tabuleiro[i][0]='O';
            tabuleiroatualizado(tabuleiro);
            return 1;
    ...
    for(i=0;i<3;i++)
    {
        ...
        if(tabuleiro[0][i]=='X' && tabuleiro[1][i]==' ' && tabuleiro[2][i]=='X')
        {
            tabuleiro[1][i]='O';
            tabuleiroatualizado(tabuleiro);
            return 1;
        }
        if(tabuleiro[0][i]==' ' && tabuleiro[1][i]=='X' && tabuleiro[2][i]=='X')
        {
            tabuleiro[0][i]='O';
            tabuleiroatualizado(tabuleiro);
            return 1;
    ...
    if(tabuleiro[0][0]==' ' && tabuleiro[1][1]=='X' && tabuleiro[2][2]=='X')
    {
        tabuleiro[0][0]='O';
        tabuleiroatualizado(tabuleiro);
        return 1;
    }
    if(tabuleiro[0][0]=='X' && tabuleiro[1][1]==' ' && tabuleiro[2][2]=='X')
    {
        tabuleiro[1][1]='O';
        tabuleiroatualizado(tabuleiro);
        return 1;
    ...
    if(tabuleiro[0][2]==' ' && tabuleiro[1][1]=='X' && tabuleiro[2][0]=='X')
    {
        tabuleiro[0][2]='O';
        tabuleiroatualizado(tabuleiro);
        return 1;
    }
    if(tabuleiro[0][2]=='X' && tabuleiro[1][1]==' ' && tabuleiro[2][0]=='X')
    {
        tabuleiro[1][1]='O';
        tabuleiroatualizado(tabuleiro);
        return 1;
